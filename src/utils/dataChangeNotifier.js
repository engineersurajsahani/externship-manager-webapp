...
export const notifyDataChange = (dataType, operation = 'update', data = null) => {
...
const deprecatedNotice = () => {
  console.warn('localStorage-based data operations are deprecated. Use API-based data fetching instead.');
};
