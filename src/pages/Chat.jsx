      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 transition-colors">
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white transition-colors">Chat</h1>
          ...
          <div className="p-4 border-b border-gray-200 dark:border-gray-700 transition-colors">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-colors"
              />
            </div>
          </div>
                ...
                {filteredProjects.map((project) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <h3 className="font-semibold text-gray-900 dark:text-white text-sm leading-tight transition-colors">
                        {project.name}
                      </h3>
                    ...
                    <div className="flex items-center mt-2">
                      <FiUsers className="w-3 h-3 text-gray-400 dark:text-gray-500 mr-1" />
        ...
        <div className="flex-1 flex flex-col">
          {selectedProject ? (
            <>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="flex items-center mt-1">
                      <FiUsers className="w-4 h-4 text-gray-400 dark:text-gray-500 mr-1" />
                  ...
                  <div className="flex items-center space-x-2">
                    {selectedProject.participants?.map((participant) => (
                      ...
                      >
                        ...
                        <span className="text-xs text-gray-500 dark:text-gray-400">No participants loaded</span>
                      )}
              ...
              {/* Messages */}
              <div className="flex-1 overflow-y-auto p-4 space-y-4 chat-scroll bg-gray-50 dark:bg-gray-900 transition-colors">
                {messages[selectedProject.id]?.map((msg) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <p className={`text-sm ${msg.isCurrentUser ? "text-white" : "text-gray-900 dark:text-white"}`}>
                        {msg.text}
                      </p>
                      <p
              ...
              <div className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-4 transition-colors">
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-colors"
                  />
                  <Button
