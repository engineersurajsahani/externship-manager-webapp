...
const Input = forwardRef(({
  ...
  const variants = {
    ...
    minimal: 'border-0 border-b-2 border-gray-300 rounded-none bg-transparent px-0 focus:ring-0 focus:border-indigo-500',
  };
      ...
      <div className="relative">
        ...
        {rightIcon && (
          <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
            <span className={error ? 'text-red-400' : success ? 'text-green-400' : 'text-gray-400'}>
              {rightIcon}
            </span>
          </div>
        )}
